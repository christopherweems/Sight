...
internal extension SiteIndex {
    static var D = SiteSet {
        ...
        "https://www.decogear.com"
            .queryURL(path: "/?s=%s")
        
        "https://defensebrand.com"
            .queryURL(path: "/search?q=%s")
        ...
        /*
         "https://skincare.dhccare.com"
             .queryURL(path: "/search?w=%s")
         */
        
        "https://www.dhccare.com"
            .queryURL(path: "/catalogsearch/result/?q=%s")
        ...
        "http://www.donmueangairportthai.com"
        ...
        "https://www.dynamiteclothing.com"
