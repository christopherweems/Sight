...
internal extension SiteIndex {
    static var G = SiteSet {
        ...
        Site("https://www.gameplanet.co.nz")
        ...
        Site("https://www.gamezebo.com")
            .queryURL(path: "/?s=%s")
        
        Site("https://www.ganderoutdoors.com")
            .queryURL(path: "/search?q=%s")
        
        Site("https://hillcity.gap.com")
            .queryURL(path: "/browse/search.do?searchText=%s")
        
        Site("https://oldnavy.gap.com")
            .queryURL(path: "/browse/search.do?searchText=%s")
        
        Site("https://www.gap.com")
            .queryURL(path: "/browse/search.do?searchText=%s")
                
        Site("https://www.garageclothing.com")
        ...
        Site("https://giantfoodstores.com")
            .queryURL(path: "/product-search/%s")
        
        Site("https://www.giftsforyounow.com")
            .queryURL(path: "/search.aspx?keyword=%s")
        
        Site("https://gigaom.com")
            .queryURL(path: "/?s=%s")
        
        Site("https://gillette.com")
            .queryURL(path: "/search.php?search_query=%s")
        
        Site("https://www.gilt.com")
            .queryURL(path: "/search?q.site_section=featured&q.query=%s")
        
        Site("https://www.gimmesomeoven.com")
            .queryURL(path: "/?s=%s")
        ...
        Site("https://www.gmc.com")
            .queryURL(path: "/search-results.html?q=%s")
        
        Site("http://www.gmi.edu.my")
            .queryURL(path: "/search_result.php?key=%s")
        ...
        Site("https://mail.google.com")
            .queryURL(path: "/mail/u/0/#search/%s")
        ...
        Site("https://translate.google.com")
            .queryURL(path: "/#auto/en/%s")
        
        Site("https://www.google.com")
            .queryURL(path: "/search?q=%s")
        
        /*
        Site("https://www.google.com/finance")
            .queryURL(path: "?q=%s")
        ...
        */
        ...
        Site("https://www.greatamericancountry.com")
            .queryURL(path: "/search/%s-")
        
        Site("https://greenkitchenstories.com")
            .queryURL(path: "/?s=%s")
        
        Site("https://www.greenlee.com")
