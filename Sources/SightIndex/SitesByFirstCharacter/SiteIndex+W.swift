...
internal extension SiteIndex {
    static var W = SiteSet {
        ...
        "https://www.wateroutfitters.com"
            .queryURL(path: "/search?q=%s")
        
        "https://www.watoday.com.au"
            .queryURL(path: "/search?text=%s")
        
        "https://waveformpodcast.com"
        ...
        "https://www.widerightnattylite.com"
            .queryURL(path: "/search?q=%s")
